...
const onboardingSchema = z.object({
  ...
  commute_mode: z.enum(["walk_bike", "public", "car_solo", "car_pool", "ev", "mixed"]).optional().nullable(),
  ...
  heating_type: z.enum(["gas", "electric", "heat_pump", "district", "wood", "none"]).optional().nullable(),
...
function commuteFactor(mode?: string | null) {
  switch (mode) {
    case "walk_bike": return 0;
    case "public": return 0.04;
    case "ev": return 0.05;
    case "car_pool": return 0.09;
    case "car_solo": return 0.19;
    case "mixed": return 0.11;
    default: return 0.12;
  }
}
function dietBaseline(d?: string | null) {
  switch (d) {
    case "vegan": return 1100;
    case "vegetarian": return 1700;
    case "flexitarian": return 2300;
    case "omnivore": return 3300;
    default: return 2500;
  }
}
function heatingBaseline(h?: string | null) {
  switch (h) {
    case "heat_pump": return 600;
    case "electric": return 1400;
    case "district": return 900;
